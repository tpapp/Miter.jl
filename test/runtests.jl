...
using Miter.Ticks: ShiftedDecimals, ShiftedDecimal, format_latex, reparse_float
...
@testset "ShiftedDecimal conversions" begin
    a = 1230000456.0
    for e in -15:4
        b = a * 10.0^e
        @test Float64(ShiftedDecimal(b)) ≈ b rtol = 1e-15
    end
end
